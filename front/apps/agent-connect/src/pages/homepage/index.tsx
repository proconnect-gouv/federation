  ...
  return (
    <FCAApiContext>
      <React.Fragment>
        ...
        <Search />
        <div className="mt48">
          <a href="https://agentconnect.gouv.fr/faq" className="is-g600 flex-columns flex-center items-center"><QuestionIcon color={'#0579EE'} size={"20"} role={"img"} className="mr4" /> J'ai besoin d'aide</a>
        </div>
      </React.Fragment>
    </FCAApiContext>
  );
