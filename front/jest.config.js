module.exports = {
  ...
  moduleNameMapper: {
    // @NOTE Modules are arranged in alphabetical order
    ...
    '@fc/partners': '<rootDir>/libs/partners/src',
    '@fc/partners/(.*)': '<rootDir>/libs/partners/src/$1',
    '@fc/routing': '<rootDir>/libs/routing/src',
    '@fc/routing/(.*)': '<rootDir>/libs/routing/src/$1',
    '@fc/service-providers': '<rootDir>/libs/service-providers/src',
    '@fc/service-providers/(.*)': '<rootDir>/libs/service-providers/src/$1',
