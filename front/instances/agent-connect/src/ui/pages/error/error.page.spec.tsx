...
import { ErrorPage, INVALID_PUBLICNESS_ERROR_CODE } from './error.page';
...
describe('ErrorPage', () => {
  ...
  it('should render the PublicnessErrorComponent when window.appError.code is INVALID_PUBLICNESS_ERROR_CODE', () => {
    // given
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (window as any).appError = { code: INVALID_PUBLICNESS_ERROR_CODE };
