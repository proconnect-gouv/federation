...
Fonctionnalité: API - instance création
  ...
  Scénario: API instance création - erreur champ obligatoire manquant
    Etant donné que je me connecte à l'espace partenaires
    Et que je prépare une requête "instance-creation"
    Et je retire "instance_name" du corps de la requête
    Quand je lance la requête avec le csrf-token
    ...
    Et le corps de la réponse a une propriété "payload.instance_name" avec 1 élément
    Et le corps de la réponse a une propriété "payload.instance_name[0]" égale à "Veuillez saisir le nom de votre instance"

  Scénario: API instance création - erreur champ non valide
    Etant donné que je me connecte à l'espace partenaires
    Et que je prépare une requête "instance-creation"
    Et je mets "abcdef" dans la propriété "signup_id" du corps de la requête
    Quand je lance la requête avec le csrf-token
    Alors le statut de la réponse est 422
    Et l'entête de la réponse a une propriété "content-type" contenant "application/json"
    Et le corps de la réponse a 4 propriétés
    ...
    Et le corps de la réponse a une propriété "message" égale à "Dto2form.exceptions.dto2formValidationError"
    Et le corps de la réponse a une propriété "payload" avec 1 attribut
    Et le corps de la réponse a une propriété "payload.signup_id" avec 1 élément
    Et le corps de la réponse a une propriété "payload.signup_id[0]" égale à "Veuillez saisir un numéro valide"

  Scénario: API instance création - plusieurs erreurs sur différentes propriétés
    Etant donné que je me connecte à l'espace partenaires
    Et que je prépare une requête "instance-creation"
    Et je retire "sp_name" du corps de la requête
    Et je mets "abcdef" dans la propriété "signup_id" du corps de la requête
    ...
    Et le corps de la réponse a une propriété "payload.sp_name" avec 1 élément
    Et le corps de la réponse a une propriété "payload.sp_name[0]" égale à "Veuillez saisir le nom de votre fournisseur de service"

  Scénario: API instance création - plusieurs erreurs sur une propriété
    Etant donné que je me connecte à l'espace partenaires
    Et que je prépare une requête "instance-creation"
    Et je mets "abcdefghij" dans la propriété "signup_id" du corps de la requête
    Quand je lance la requête avec le csrf-token
    Alors le statut de la réponse est 422
    Et l'entête de la réponse a une propriété "content-type" contenant "application/json"
    Et le corps de la réponse a 4 propriétés
    ...
    Et le corps de la réponse a une propriété "message" égale à "Dto2form.exceptions.dto2formValidationError"
    Et le corps de la réponse a une propriété "payload" avec 1 attribut
    Et le corps de la réponse a une propriété "payload.signup_id" avec 2 éléments
    Et le corps de la réponse a une propriété "payload.signup_id[0]" égale à "Le numéro de la demande datapass doit être de 7 caractères maximum"
    Et le corps de la réponse a une propriété "payload.signup_id[1]" égale à "Veuillez saisir un numéro valide"
