...
Fonctionnalité: Instance - Modification avec erreurs
  ...
  Scénario: Instance Modification - Défiler vers la première erreur
    ...
    Et les champs suivants sont en erreur dans le formulaire de modification d'instance
      ...
      | instance_name | Veuillez saisir le nom de votre instance                                      |
      | entity_id     | Veuillez saisir le client id de votre fournisseur de service FranceConnect v1 |
    Et le champ "instance_name" est visible à l'écran dans le formulaire de modification d'instance
    Et le champ "entity_id" n'est pas visible à l'écran dans le formulaire de modification d'instance
  ...
  Scénario: Instance Modification - Modification après correction
    ...
    Et que j'entre "abcdef" dans le champ "signup_id" du formulaire de modification d'instance
    Et que je valide le formulaire de modification d'instance
    Et que je suis sur la page modification d'instance
    Et que l'erreur du champ "signup_id" contient "Veuillez saisir un numéro valide" dans le formulaire de modification d'instance
    Quand j'entre "123000" dans le champ "signup_id" du formulaire de modification d'instance
    Et je valide le formulaire de modification d'instance
