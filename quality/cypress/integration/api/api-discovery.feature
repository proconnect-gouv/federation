...
Fonctionnalité: API - discovery
  ...
  Scénario: API discovery - fca-low
    ...
    Et "acr_values_supported" contient uniquement "eidas0 eidas0-mfa eidas1 eidas1-mfa eidas2 eidas3 https://proconnect.gouv.fr/assurance/certification-dirigeant" dans la configuration openid
    ...
    Et "claims_supported" contient "sub amr uid given_name email phone_number organizational_unit siren siret usual_name belonging_population chorusdt:matricule chorusdt:societe chorusdt:societe idp_id idp_acr acr sid auth_time iss" dans la configuration openid
