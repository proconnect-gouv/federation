...
Fonctionnalité: Connexion Usager - Sub
  Scénario: retourne le même sub à deux FS différents quand j'utilise le même compte
  ...
  Scénario: retourne le même sub pour une reconnexion sur un même FS avec le même compte
    Etant donné que je navigue sur la page fournisseur de service "premier FS"
    Et que je clique sur le bouton ProConnect
    Et que j'entre l'email "test@fia1.fr"
    Et que je clique sur le bouton de connexion
  ...
  @ignoreInteg01
  Scénario: retourne le sub déjà enregistré pour deux comptes connus qui sont rattachés à un même sub dans ProConnect
    Etant donné que je navigue sur la page fournisseur de service "premier FS"
    Et que je clique sur le bouton ProConnect
    ...
    Et que je clique sur le bouton de connexion
    Quand j'utilise le compte usager avec le sub "s7Ht2K9pL5mN8vX3cR4wQ"
    Et que je m'authentifie
    Alors le sub transmis au fournisseur de service est le suivant "d68cec59-ed65-48ab-bfbf-1ca65dd807f8"
    Alors le sub transmis au fournisseur de service est identique au sub mémorisé
