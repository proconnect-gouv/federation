...
Fonctionnalité: API - discovery
  ...
  Scénario: API discovery - fca-low
    ...
    Et "acr_values_supported" contient uniquement "eidas1 eidas2 eidas3 https://proconnect.gouv.fr/assurance/certification-dirigeant" dans la configuration openid
