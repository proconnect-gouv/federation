...
export class GristPublisherService {
  ...
  async publishServiceProvidersToGrist(
    ...
    return this.publishToGrist(
      serviceProviderGristRecords,
      gristServiceProvidersTableId,
    );
  }

  async publishIdentityProvidersToGrist(
  ...
  transformIdentityProviderToGristRecord(
