...
import { itemPerPage } from '@pc/shared/public/javascript/item-par-page';
...
import {
  removeItem,
  updateItem,
} from '@pc/shared/public/javascript/modals/confirm-form';
import { customFileInput } from './custom-file-input';
import { lazyInit } from '@pc/shared/public/javascript/lazy-init';
import { validateEnrollment } from './validate-enrollment';
import { comparePassword } from '@pc/shared/public/javascript/compare-password';
import { copyText } from '@pc/shared/public/javascript/clipboard';
import { rnippForm } from '@pc/shared/public/javascript/rnipp-form';
import { validateInputDate } from './validate-input-date';
import { validateInputHour } from './validate-input-hour';
import { validateAccountUpdate } from '@pc/shared/public/javascript/validateAccountUpdate';
import { validateAccountCreate } from '@pc/shared/public/javascript/validateAccountCreate';
