...
import { SessionGenericCsrfService } from './session-generic-csrf.service';
...
describe('SessionGenericCsrfService', () => {
  let service: SessionGenericCsrfService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<SessionGenericCsrfService>(SessionGenericCsrfService);
