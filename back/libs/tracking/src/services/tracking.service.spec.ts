...
describe('TrackingService', () => {
  ...
  let buildLogSpy: jest.SpyInstance;
  ...
  describe('track', () => {
    it('should call `appTrackingService.buildLog()` & logger.businessEvent methods', async () => {
      // Given
      buildLogSpy = jest.spyOn(service as any, 'buildLog');
      buildLogSpy.mockReturnValue({});
      ...
      // Then
      expect(buildLogSpy).toHaveBeenCalledTimes(1);
      expect(buildLogSpy).toHaveBeenCalledWith(
