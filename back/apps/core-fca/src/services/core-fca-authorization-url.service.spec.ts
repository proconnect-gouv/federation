...
describe('CoreFcaAuthorizationUrlService', () => {
  ...
  describe('getAuthorizeUrl() feature handling', () => {
    it('should call `core-fca-default-authorization-url` when service call the function', async () => {
      // Given
    ...
    it('should call `core-fca-mcp-authorization-url` when service call the function', async () => {
      // Given
