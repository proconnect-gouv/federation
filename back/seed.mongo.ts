...
import { accountsFca } from "./seed-data/account-fca.ts";
import { dataProviders } from "./seed-data/dp.ts";
import { identityProviders } from "./seed-data/idp.ts";
import { deskScopes, identityScopes } from "./seed-data/scopes.ts";
import { serviceProviders } from "./seed-data/sp.ts";
